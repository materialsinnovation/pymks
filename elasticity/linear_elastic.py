...
filename_mesh = data_dir + '/sfepy/meshes/3d/cylinder.mesh'
#! Regions
#! -------
...
def lam_func(ts, coors, problem, equations=None, mode=None, **kwargs):
    if mode == 'qp':
        v = 9. * (coors[:,0] > 0.5) + 1.
...
equations = {
    'balance_of_forces' :
    """dw_lin_elastic_iso.i.Omega(lam.val, solid.mu, v, u ) = 0""",
}
#! Solvers
#! -------
